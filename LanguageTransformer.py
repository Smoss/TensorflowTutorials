...
class Transformer(tf.keras.Model):
    def __init__(self, num_layers, d_model, num_heads, dff, input_vocab_size, target_vocab_size, pe_input, pe_target, rate=.1):
...
for epoch in range(EPOCHS):
    ...
    for (inp, tar) in tqdm.tqdm(train_dataset, total=BUFFER_SIZE//BATCH_SIZE):
        train_step(inp, tar)
